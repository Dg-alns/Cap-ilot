...
namespace Unity.Services.Samples.Friends
{
    public class RelationshipsManager : MonoBehaviour
    {
        ...
        void UIInit()
        {
            ...
            m_FriendsListView.SendingTextFriend += SendMessageFriendAsync;
        ...
        async void SendMessageFriendAsync(string id)
        {
            await SendMessageFriend(id);
        }
        ...
        async Task SendMessageFriend(string playerId)
        {
            try
            {
